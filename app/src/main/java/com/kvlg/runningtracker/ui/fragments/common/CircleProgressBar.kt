...
class CircleProgressBar(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        try {
            strokeWidth = typedArray.getDimension(R.styleable.CircleProgressBar_cpb_progressBarThickness, strokeWidth)
            progress = typedArray.getFloat(R.styleable.CircleProgressBar_cpb_progress, progress)
            color = typedArray.getInt(R.styleable.CircleProgressBar_cpb_progressbarColor, color)
            min = typedArray.getInt(R.styleable.CircleProgressBar_cpb_min, min)
            max = typedArray.getInt(R.styleable.CircleProgressBar_cpb_max, max)
        } finally {
            typedArray.recycle()
        }
